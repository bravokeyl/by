...
( function( $ , api ) {
    ...
    // Site footer bg
    /*
    wp.customize( 'sumerian_footer_bg', function( value ) {
    ...
    */
    ...
    // Site footer info bg
    wp.customize( 'sumerian_footer_info_bg', function( value ) {
        value.bind( function( to ) {
    ...
    // Site footer widgets
    wp.customize( 'sumerian_btt_disable', function( value ) {
        value.bind( function( to ) {
            if ( to === true || to == 'true' ) {
    ...
    $( window ).resize( function(){
        var css_code = $( '#sumerian-style-inline-css' ).html();
        // Fix Chrome Lost CSS When resize ??
        $( '#sumerian-style-inline-css' ).html( css_code );
    });


    wp.customize.selectiveRefresh.bind( 'partial-content-rendered', function( settings ) {

        if (  settings.partial.id  == 'sumerian-header-section' ) {
