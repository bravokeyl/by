( function( api ) {
    ...
    api.sectionConstructor['sumerian-plus'] = api.Section.extend( {
		...
		_init: function() {
            ...
            control.actions = function ($context) {
                if (control.params.live_title_id) {
                    ...
                    if (control.id === 'sumerian_section_order_styling') {
    ...
    function _the_editor( container ){
        var _editor = {
            ...
            ready: function( container ) {
                ...
                control.container.addClass( 'sumerian-editor-added' );
...
jQuery( window ).ready( function( $ ){
    ...
    if ( typeof sumerian_customizer_settings !== "undefined" ) {
        if (sumerian_customizer_settings.number_action > 0) {
            $('.control-section-themes h3.accordion-section-title').append('<a class="theme-action-count" href="' + sumerian_customizer_settings.action_url + '">' + sumerian_customizer_settings.number_action + '</a>');
        }
    }
     ...
     */
    $( 'select[data-customize-setting-link="sumerian_hero_layout"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-sumerian_hcl']").hide();
        $( "li[id^='customize-control-sumerian_hcl"+v+"']").show();

    } );
    $( 'select[data-customize-setting-link="sumerian_hero_layout"]').trigger( 'on_custom_load' );
    ...
    $( 'select[data-customize-setting-link="sumerian_gallery_display"]').on( 'change on_custom_load', function(){
        ...
        switch ( v ) {
            case 'slider':
                $( "#customize-control-sumerian_g_row_height, #customize-control-sumerian_g_col, #customize-control-sumerian_g_spacing").hide();
                break;
            case 'justified':
                $( "#customize-control-sumerian_g_col, #customize-control-sumerian_g_spacing").hide();
                $( "#customize-control-sumerian_g_row_height").show();
                break;
            case 'carousel':
                $( "#customize-control-sumerian_g_row_height, #customize-control-sumerian_g_col").hide();
                $( "#customize-control-sumerian_g_col, #customize-control-sumerian_g_spacing").show();
                break;
            case 'masonry':
                $( "#customize-control-sumerian_g_row_height").hide();
                $( "#customize-control-sumerian_g_col, #customize-control-sumerian_g_spacing").show();
                break;
            default:
                $( "#customize-control-sumerian_g_row_height").hide();
