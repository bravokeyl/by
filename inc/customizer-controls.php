...
class sumerian_Section_Plus extends WP_Customize_Section {
    /**
...
/*-----------------------------------------------------------------------------------*/
/*  sumerian Customizer Controls
/*-----------------------------------------------------------------------------------*/

class sumerian_Misc_Control extends WP_Customize_Control {
...
class sumerian_Theme_Support extends WP_Customize_Control {
	public function render_content() {
		echo wp_kses_post( 'Upgrade to <a href="#">sumerian Plus</a> to be able to change the section order and styling!', 'sumerian' );
	}
}
...
class sumerian_Editor_Custom_Control extends WP_Customize_Control
{
    /**
 ...
 */
class sumerian_Alpha_Color_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class sumerian_Customize_Repeatable_Control extends WP_Customize_Control {
    ...
    public function __construct( $manager, $id, $args = array() )
    {
        ...
        if ( ! isset( $args['allow_unlimited'] ) || $args['allow_unlimited'] != false ) {
            $this->max_item =  apply_filters( 'sumerian_reepeatable_max_item', absint( $args['max_item'] ) );
        }  else {
            $this->max_item = absint( $args['max_item'] );
        }

        $this->changeable =  isset(  $args['changeable'] ) && $args['changeable'] == 'no' ? 'no' : 'yes';
        $this->default_empty_title =  isset(  $args['default_empty_title'] ) && $args['default_empty_title'] != '' ? $args['default_empty_title'] : esc_html__( 'Item', 'sumerian' );
    ...
    public function render_content() {
        ...
        <div class="repeatable-actions">
            <span class="button-secondary add-new-repeat-item"><?php _e( 'Add an item', 'sumerian' ); ?></span>
        </div>
        <?php
    }
            ...
            <div class="widget">
                <div class="widget-top">
                    ...
                    <div class="widget-title">
                        <h4 class="live-title"><?php _e( 'Item', 'sumerian' ); ?></h4>
                    </div>
                </div>
                                ...
                                <# if ( field.type ){ #>
                                    ...
                                    #>
                                        ...
                                        <# } else if ( field.type == 'media' ) { #>
                                            ...
                                            <div class="actions">
                                                <button class="button remove-button " <# if ( ! field.value.url ){ #> style="display:none"; <# } #> type="button"><?php _e( 'Remove', 'sumerian' ) ?></button>
                                                <button class="button upload-button" data-media="{{field.media}}" data-add-txt="<?php esc_attr_e( 'Add', 'sumerian' ); ?>" data-change-txt="<?php esc_attr_e( 'Change', 'sumerian' ); ?>" type="button"><# if ( ! field.value.url  ){ #> <?php _e( 'Add', 'sumerian' ); ?> <# } else { #> <?php _e( 'Change', 'sumerian' ); ?> <# } #> </button>
                                        ...
                                        <# }  else if ( field.type == 'icon'  ) { #>
                                            ...
                                            <a href="#" class="remove-icon"><?php esc_html_e( 'Remove', 'sumerian' ); ?></a>
                                        <# }  #>
                            ...
                            <div class="widget-control-actions">
                                <div class="alignleft">
                                    <span class="remove-btn-wrapper">
                                        <a href="#" class="repeat-control-remove" title=""><?php _e( 'Remove', 'sumerian' ); ?></a> |
                                    </span>
                                    <a href="#" class="repeat-control-close"><?php _e( 'Close', 'sumerian' ); ?></a>
                                </div>
                                <br class="clear">
                            </div>
 ...
 * @since 2.0.0
 */
class sumerian_Category_Control extends WP_Customize_Control {
    ...
    protected function render_content() {
        ...
        $dropdown_args = wp_parse_args( $this->dropdown_args, array(
            ...
            'show_option_none'  => '',
            'selected'          => $this->value(),
            'show_option_all'   => __( 'All', 'sumerian' ),
            'orderby'           => 'id',
            'order'             => 'ASC',
            'show_count'        => 1,
            'hide_empty'        => 1,
...
function sumerian_enqueue_editor(){
...
function onepres_customizer_control_scripts(){
    ...
    wp_enqueue_script( 'sumerian-customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-controls', 'wp-color-picker' ) );
    wp_enqueue_style( 'sumerian-customizer',  get_template_directory_uri() . '/assets/css/customizer.css' );

}

add_action( 'customize_controls_enqueue_scripts', 'onepres_customizer_control_scripts', 99 );
add_action( 'customize_controls_enqueue_scripts', array( 'sumerian_Editor_Scripts', 'enqueue' ), 95 );
